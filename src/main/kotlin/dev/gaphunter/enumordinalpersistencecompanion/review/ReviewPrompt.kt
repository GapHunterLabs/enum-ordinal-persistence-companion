package dev.gaphunter.enumordinalpersistencecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.enumordinalpersistencecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.enumordinalpersistencecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Enum-Ordinal Persistence Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34007-enum-ordinal-persistence-companion/reviews"
